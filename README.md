...
[![npm version](https://badge.fury.io/js/@ansvar%2Fgreek-law-mcp.svg)](https://www.npmjs.com/package/@ansvar/greek-law-mcp)
...
**Endpoint:** `https://mcp.ansvar.eu/law-gr/mcp`

| Client | How to Connect |
|--------|---------------|
| **Claude.ai** | Settings > Connectors > Add Integration > paste URL |
| **Claude Code** | `claude mcp add greek-law --transport http https://mcp.ansvar.eu/law-gr/mcp` |
...
```json
{
  "mcpServers": {
    "greek-law": {
      "type": "url",
      "url": "https://mcp.ansvar.eu/law-gr/mcp"
    }
  }
}
```
...
### [@ansvar/bulgarian-law-mcp](https://github.com/Ansvar-Systems/Bulgarian-law-mcp)
