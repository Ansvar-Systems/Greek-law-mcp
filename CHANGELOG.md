...
## [1.0.0] - 2026-02-21
### Added
- Initial release of Greek Law MCP
- `search_legislation` tool for full-text search across Greek legislation
...
- `get_greek_implementations` tool for finding national EU implementations
...
[1.0.0]: https://github.com/Ansvar-Systems/Greek-law-mcp/releases/tag/v1.0.0
